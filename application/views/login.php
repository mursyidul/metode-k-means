...
<head>
    ...
    <section class="content">
        <div class="row" style="margin-top:1%;">
			<div class="col-md-12">
			<center><img src="<?php echo base_url('assets/img/download1.png'); ?>" width="20%" class="rounded" alt="User Image" /></center><br/>
			<div class="col-md-3"></div>
            <div class="col-md-6">
                <section class="panel">
                <div class="panel-body table-responsive">
                <center><h3>PENCARIAN KELOMPOK PROFIL MAHASISWA UNTUK MENENTUKAN STRATEGI PROMOSI</h3><hr/>
                ...
                <p>&nbsp;</p>
                <center><sub>Copyright &copy; UNIVERSITAS MUHAMMADIYAH GRESIK, <?php echo date('Y'); ?></sub></center>
            </div>
            <div class="col-md-3"></div>
			</div>
        </div>
