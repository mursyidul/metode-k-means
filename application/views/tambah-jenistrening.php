    ...
    <section class="content">
        ...
        <div class="row">
            ...
            TAMBAH JENIS TRENING
                ...
                <?php echo form_open('Jenistrening/tambah-proses',['class'=>'form-horizontal style-form']); ?>
					<table class="table table-bordered">
					<tr class="success"><th colspan="2">TAMBAH JENIS TREINING</th></tr>
					<tr><td width="150">Nama Jenis Trening</td>
                            <td>
								<div class="col-sm-6">
                                  <input name="nama_jenistrening" type="text" id="no_induk" class="form-control" placeholder="Nama Jenis Trening" required />
                              </div>
                    </td></tr>
