    ...
    <section class="content">
        ...
        <div class="row">
            ...
            EDIT JENIS TRENING
                ...
                <?php foreach ($centroid1 as $key => $value) { ?>
                <?php echo form_open('Nilai_profil1/edit-proses/'.$value->id_centroid1,['class'=>'form-horizontal style-form']); ?>
          ...
          <tr><td width="150">Usia</td>
                            <td>
              <div class="col-sm-2">
                                  <input name="usia" type="text" id="no_induk" class="form-control" value="
                                  <?php echo $value->usia; ?>" placeholder="Usia" required />
                              </div>
                    </td>
          </tr>
