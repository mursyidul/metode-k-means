    ...
    <section class="content">
        ...
        <div class="row">
            ...
            TAMBAH JENIS TRENING
                ...
                <?php echo form_open('Daerah_asal/tambah-proses',['class'=>'form-horizontal style-form']); ?>
					<table class="table table-bordered">
					<tr class="success"><th colspan="2">TAMBAH Daerah</th></tr>
					<tr><td width="150">Nama Daerah Asal</td>
                            <td>
								<div class="col-sm-6">
                                  <input name="nama_kota" type="text" id="no_induk" class="form-control" placeholder="Nama kota" required />
                              </div>
                    </td></tr>
