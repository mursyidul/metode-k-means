        ...
        <div class="row">
            ...
            TAMBAH JENIS TRENING
                ...
                <?php echo form_open('mahasiswa/edit-proses/'.$key->id_mahasiswa,['class'=>'form-horizontal style-form']); ?>
                  ...
                  <?php echo editcombo('jeniskelamin','jenis_kelamin','col-sm-4','jenis_kelamin','id_jenis','','',$key->id_jenis); ?>
                    </td></tr>
					<tr><td>Jurusan Sekolah</td><td>
                            <?php echo editcombo('jurusansekolah','jurusan_sekolah','col-sm-4','jurusan_sekolah','id_jurusan','','',$key->id_jurusan); ?>
                    </td></tr>
					<tr><td>Kelas</td><td>
                <?php echo editcombo('kelas1','kelas','col-sm-4','kelas','id_kelas','','',$key->id_kelas); ?>
                    </td></tr>
					<tr><td>Daerah Asal</td><td>
                    <?php echo editcombo('kotaasal','kota_asal','col-sm-4','kota_asal','id_kota','','',$key->id_kota); ?>
                    </td></tr>
					<tr><td>Pekerjaan Mahasiswa</td><td>
                     <?php echo editcombo('pekerjaanmahasiswa','pekerjaan_mahasiswa','col-sm-4','pekerjaan_mahasiswa','id_pekerjaan','','',$key->id_pekerjaan); ?>
                    </td></tr>
					<tr><td>Penghasilan Orang Tua</td><td>
                <?php echo editcombo('penghasilanortu','penghasilan_ortu','col-sm-4','penghasilan_ortu','id_penghasilan','','',$key->id_penghasilan); ?>
                    </td></tr>
					<tr><td>Sekolah</td><td>
                  <?php echo editcombo('sekolah1','sekolah','col-sm-4','sekolah','id_sekolah','','',$key->id_sekolah); ?>
                    </td></tr>
         <tr><td>Status</td><td>
                    <?php echo editcombo('status','status','col-sm-4','status','id_status','','',$key->id_status); ?>
                    </td></tr>
