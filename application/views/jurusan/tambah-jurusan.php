    ...
    <section class="content">
        ...
        <div class="row">
            ...
            TAMBAH JENIS TRENING
                ...
                <?php echo form_open('Jurusan/tambah-proses',['class'=>'form-horizontal style-form']); ?>
					<table class="table table-bordered">
					<tr class="success"><th colspan="2">TAMBAH JURUSAN SEKOLAH</th></tr>
					<tr><td width="150">Nama Jurusan Sekolah</td>
                            <td>
								<div class="col-sm-6">
                                  <input name="nama_jurusan" type="text" id="no_induk" class="form-control" placeholder="Nama Jurusan Sekolah" required />
                              </div>
                    </td></tr>
